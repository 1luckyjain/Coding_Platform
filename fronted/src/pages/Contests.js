...
const Contests = () => {
  ...
  const contests = [
    ...
    },
    {
      ...
      description:
        "Annual winter contest with problems of varying difficulty levels for all skill ranges.",
      status: "Completed",
      date: "Jan 15, 2024 2:00 PM - Jan 15, 2024 6:00 PM",
      participants: 203,
      problems: 3,
    },
  ];
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <button className="px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg shadow hover:opacity-90 transition">
          + Create Contest
        </button>
      </div>
        ...
        {filteredContests.map((contest) => (
          ...
          >
            ...
            <div className="text-sm text-gray-500 space-y-1 mb-4">
              ...
              {contest.status === "Active" && <p>⏳ {contest.remaining}</p>}
